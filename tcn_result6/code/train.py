            ...
            "transition_rules": {
                ...
                "transition_matrix": {
                    ...
                    "restrictive_transitions": [
                        {"from": "standing", "to": "no_activity", "threshold": 0.3},
                        {"from": "sitting", "to": "no_activity", "threshold": 0.3},
                        {"from": "no_activity", "to": "standing", "threshold": 0.7},
                        {"from": "no_activity", "to": "sitting", "threshold": 0.7}
                    ]
                },
                "state_durations": {
