...
class TCN(nn.Module):
    def __init__(self, input_size, output_size, num_channels, kernel_size, dropout, use_se=False):
        ...
        self.no_activity_threshold = 0.97  # no_activity 클래스에 대한 threshold 약간 낮춤
        self.temporal_window = 9  # 시간적 일관성을 위한 윈도우 크기 증가
        ...
        self.transition_matrix[0, 3] = 0.8  # standing -> no_activity 제한
        self.transition_matrix[1, 3] = 0.8  # sitting -> no_activity 제한
        self.transition_matrix[2, 3] = 1.0  # walking -> no_activity
        # no_activity에서 다른 상태로의 전이는 쉽게 허용
        self.transition_matrix[3, 0] = 1.2  # no_activity -> standing 허용도 증가
        self.transition_matrix[3, 1] = 1.2  # no_activity -> sitting 허용도 증가
