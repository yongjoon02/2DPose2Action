...
class TCN(nn.Module):
    def __init__(self, input_size, output_size, num_channels, kernel_size, dropout, use_se=False):
        ...
        self.no_activity_threshold = 0.97  # 원래 값으로 복구
        self.temporal_window = 10  # 9에서 10으로만 약간 증가
        ...
        # 다른 상태에서 no_activity로의 전이 확률 조정
        self.transition_matrix[0, 3] = 0.8  # standing -> no_activity
        self.transition_matrix[1, 3] = 0.8  # sitting -> no_activity
        self.transition_matrix[2, 3] = 1.0  # walking -> no_activity
        # no_activity에서 다른 상태로의 전이
        self.transition_matrix[3, 0] = 1.2  # no_activity -> standing
        self.transition_matrix[3, 1] = 1.2  # no_activity -> sitting
